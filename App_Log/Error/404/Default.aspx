<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="App_Log_Error_404_Default" %>
    ...
    <div class="container panel panel-default">
      <div class="panel-body">
        <div class="col-xs-12 col-md-4 textAlignCenter">
          ...
          <h1>404</h1>
          <div class="h2">Page not found, sorry!</div>
        </div>
        <div class="col-xs-12 col-md-8 ">
          <h4>The reason for this page being displayed may be because:</h4>
            <ul>
              <li>You have clicked on an out of date link and the page no longer exists, or</li>
              <li>the service temporarily went down causing the server to display this page.</li>
            </ul>
